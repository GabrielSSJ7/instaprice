...
function (_React$Component) {
  ...
  function Post(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleImage", function (event) {
      ...
      if (event.target.files[0]) {
        ...
        output.src = _config_types__WEBPACK_IMPORTED_MODULE_5__["URL"].createObjectURL(event.target.files[0]);
      } else {
        output.src = "";
  ...
  _createClass(Post, [{
    key: "inserirProduto",
    value: function inserirProduto(id, event) {
      ...
      function (snapshot) {
        ...
        uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
          ...
          instance.post("".concat(_config_types__WEBPACK_IMPORTED_MODULE_5__["URL"], "insert"), data).then(function (res) {}).catch(function (err) {
            _this2.setState({
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        __self: this
      }, "Divulgar")))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_BottomMenu__WEBPACK_IMPORTED_MODULE_3__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 211
        },
...
//# sourceMappingURL=Post.js.1884b68b78cf54f7650c.hot-update.js.map