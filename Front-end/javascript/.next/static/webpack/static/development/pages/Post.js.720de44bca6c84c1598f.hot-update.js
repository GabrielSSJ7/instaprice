    ...
    value: function inserirProduto(event, ctx) {
      ...
      function (snapshot) {
        ...
        uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
          ...
          instance.post("".concat(_config_types__WEBPACK_IMPORTED_MODULE_5__["URL"], "insert"), data).then(function (res) {
            Router.push("/");
          }).catch(function (err) {
            _this2.setState({
...
//# sourceMappingURL=Post.js.720de44bca6c84c1598f.hot-update.js.map