  ...
  _createClass(profile, null, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref) {
        var store, isServer, req, cookie, index, AuthToken, end, start, token, options, user, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                end = AuthToken.indexOf("; ");
                start = AuthToken.indexOf("bearer");
                AuthToken = AuthToken.substring(0, end);
              ...
              case 17:
                data = _context.sent;
                console.log("user data", user); //const data = []
...
//# sourceMappingURL=Profile.js.ba875b3f35b668d0d894.hot-update.js.map